...
export async function createCodexZipArchive(payloadBytes, payloadFilename, codexEntry) {
  ...
  // Create a copy of the codex entry and exclude storage.location
  const codexEntryCopy = JSON.parse(JSON.stringify(codexEntry));
  ...
  // Note: The comment includes the full codex entry, including storage.location
